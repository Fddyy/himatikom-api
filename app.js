...
app.get("/blogs", async (req, res) => {
    ...
    res.json(blogs.map(({id, title, slug, content, author, created_at, image_url }) => ({id, title, slug, content, author, created_at, image_url })));
});
...
app.get("/home/blogs", async (req, res) => {
    ...
    res.json(sortedBlogs.map(({title, slug,content,author, created_at, image_url }) => ({ title, slug,content,author, created_at, image_url })));
});
